                    ...
                    <div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                if ($exp == null) {
                                    ?>
                                    <a href="<?php echo base_url() . "index.php/reporte/xls_participantes/$retiro_id/"; ?>" target="_blank"><button id="button1id" name="button1id" class="btn btn-success">EXCEL</button></a>
                                    <a href="<?php echo base_url() . "index.php/pdf/create_participantes/$retiro_id/"; ?>" target="_blank"><button id="PDF" name="PDF" class="btn btn-danger">PDF</button></a>
                                    <?php
                                } else {
                                    ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody  id="fbody">
                            ...
                            if ($participantes != NULL) {
                                ...
                                echo "<tr><td><strong>NO HAY PARTICIPANTES AGREGADOS AÚN EN ESTE RETIRO</strong></td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
